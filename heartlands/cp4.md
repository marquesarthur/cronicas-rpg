...
<img 
  src='https://i.pinimg.com/564x/55/9a/f5/559af5cb7b68251b2a112754d108e2c4.jpg' 
  style='position:absolute;bottom:60px;right:10px;width:400px;mix-blend-mode:multiply'/>  
  
<img 
  src='http://i.imgur.com/nzPYZyD.png' 
  style='position:absolute;top:220px;left:540px;width:300px' />
...
<img 
  src='http://i.imgur.com/nzPYZyD.png' 
  style='position:absolute;top:870px;left:540px;width:400px' />
...
Zarion segue pelas ruas da cidade e percebe que ela está entregue ao caos. Há pouca ordem e a guarda não se preocua em policiar atividades ilícitas ou duvidosas. Zarion faz seu caminho até a estalagem em segurança e consegue traçar uma rota para que os demais se esgueirem sem que suas raças chamem atenção. Nos movemos até a estalagem e eu trato de falar com os serviçais do estabelicimento.
...
<img 
  src='http://i.imgur.com/nzPYZyD.png' 
  style='position:absolute;top:480px;left:5px;width:300px' />
...
Urachin também nos informa que dentro de uma semana Thorin casará com Thessaly e que um grande baile de mascarás atrairá nobres de diversas regiões para a região nobre da cidade. Ele acredita que é possível nos infiltrar no baile. Sendo assim, devemos nos preparar para assumirmos personas de modo que possamos descobrir os próximos passos de Thorin e da corte de Hillsfar.


<span style="font-family: 'Julee', cursive;">Zarion</span>, como um bom bêbado, se disfarça como um mestre cervejeiro. Ele prepara uma bêbida leve mas extremamente potente para entregar aos convidados mais próximos à Thorin. Ele passa dias trabalhando na cozinha da corte até que é chegado o dia do evento. 

Escutando boatos sobre outras facções na cidade, <span style="font-family: 'Julee', cursive;">Cedro</span> -- o druída -- entre em comunhão com ratos e corujas e tenta descobrir mais sobre as atividades destas facções. Para sua surpresa, ele descobre presenças demoníacas na cidade.

<span style="font-family: 'Julee', cursive;">Zerathur</span> como um combatente não consegue ajudar muito. Ele tenta se passar por um peão para trabalhar no curral do castelo, mas é demitido no primeiro dia. 

<span style="font-family: 'Julee', cursive;">Evendur</span> também trabalha na cozinha. Ele tenta descobrir boatos na corte, mas sem grandes sucessos.

Eu, <span style="font-family: 'Julee', cursive;">Clyde</span>, vou me passar por um excêntrico nobre halfling que tratará de registrar os eventos do casamento em meu "livro" de registros para que clérigos da deusa do conhecimento acompanhem a árvore genealógica da família de Thorin.

<img 
  src='https://i.pinimg.com/564x/99/bc/89/99bc89d6f42855203e6302976ba96f88.jpg' 
  style='position:absolute;bottom:60px;right:10px;width:400px;mix-blend-mode:multiply'/>
  

 
<img src='http://i.imgur.com/nzPYZyD.png' 
  style='position:absolute;top:240px;left:650px;width:300px' />
  
<img src='http://i.imgur.com/nzPYZyD.png' 
  style='position:absolute;top:240px;left:280px;width:300px' />
  
<img src='http://i.imgur.com/nzPYZyD.png' 
  style='position:absolute;top:900px;left:280px;width:300px' /> 
...
É chegado o dia do baile e seguímos com nossos disfarces. Eu sigo para a cerimônia como um halfling nobre em uma espalhafatosa máscara de um sátiro. Cedro me acompanha como meu guarda-costas em uma máscara de urso. <span style="color: red; font-family: 'Julee', cursive;">Bem adequado.</span>

Somos barrados por dois guardas que nos interrogam sobre nossas raças e tentam nos intimidar. Eu retruco que esse não é o comportamento padrão de um soldado e alguém de minha estipe deveria ser abordado no mínimo pelo capitão da guarda. Intimidado, o guarda engole em seco e nos deixa seguir em frente. <span style="color: red; font-family: 'Julee', cursive;">Quanta petulância, as pessoas confundem xenofobia com inteligência. Está para nascer o dia que um mero guarda passará a perna em Clyde Chestnut Barrow. Ha Ha.</span>

Enquanto adentro no castelo, Evendur trabalha na cozinha. Ele é escalado para ser um dos garçons da festa e isto lhe dá a oportunidade de escutar a conversa de vários dos nobres. Em especial, ele escuta planos dos magos vermelhos de Thay. Algo sobre agir no momento certo. Zarion continua servindo sua bebida para os convidados e seu alto teor alcóolico faz com que boatos e fofocas sejam espalhados mais facilmente.
...
<span style="font-family: 'Julee', cursive;">Zarion tem pavio curto e gosta de entrar em ação, mas ao mesmo tempo ele foi sagaz e pensou no plano da bebida. Eu não tenho certeza sobre esse monge alcólatra.</span>


<span style="font-family: 'Julee', cursive;">Evendur é um pouco covarde, mas ele é capaz de usar da língua ladina e passar sinais e estratégias sem que os inimigos percebam. Eu ainda não sei muito sobre sua relação com Constância, mas ele parece ser uma pessoa confiável.</span>

<span style="font-family: 'Julee', cursive;">Zerathur continua o aliado de sempre, bate feito um ogro e escuta como uma criança de 5 anos. Enquanto ele me proteger, eu o protegerei. Tenho uma grande dívida com o meu singelo amigo meio-orc. Eu espero que um dia ele não se decepcione com minhas ações.</span>
...
<div style="text-align: center">
  <img 
    src='https://i.imgur.com/yyAaqzr.png' 
    style='width:450px;mix-blend-mode:multiply' />
	<span style="color: red; font-family: 'Julee', cursive;">Meu Cachimbo Mágico</span>
</div>
...
<span style="font-family: 'Julee', cursive;">No meio de tantos acontecimentos, eu quase me esqueci de mencionar que no meio do combate meu antebraço começou a coçar ou formigar. Não sei descrever bem a sensação, mas quando chequei ele, percebi a marca de Tymora deusa da sorte como uma espécie de tatuagem. Como precisamos escapar do castelo, não dei tanta atenção e no dia seguinte averiguei se a marca continuava no mesmo local. Ela sumiu [para o meu alívio ou não]. Não tenho certeza se Tymora tem algum plano para mim, mas a ausência dos deuses nos últimos tempos e a recente tempestade nos céus com diversos dos símbolos dos deuses surgindo no meio dos trovões e relâmpagos me faz pensar que esta não foi uma mera coincidência. Veremos...</span>
...
<img 
  src='https://i.imgur.com/ku3kPDC.png' 
  style='position:absolute;bottom:0px;right:400px;width:400px;mix-blend-mode:multiply'/>
  


<img 
  src='https://i.imgur.com/xmps2O7.png' 
  style='position:absolute;bottom:60px;right:-0px;width:500px;mix-blend-mode:multiply; -webkit-transform: scaleX(-1); transform: scaleX(-1);'/>
